...
const CHAPTERS: Chapter[] = [
    ...
    },
    {
        ...
        vods: [
            ...
            { id: 'vod_22', title: 'AI 실전 : 내가 원하는 사진 소스를 만드는 실전 워크플로우', duration: 20 },
            { id: 'vod_23', title: 'AI로 멈춰 있는 사진 소스를 움직이는 영상 소스로 만드는 방법', duration: 22 },
            { id: 'vod_24', title: 'AI 실전 : 내가 원하는 영상 소스를 만드는 실전 워크플로우', duration: 25 },
        ],
    },
    {
        id: 'ch5',
        title: 'Part 5. 편집 실전',
        vods: [
            { id: 'vod_25', title: '영상 시청 지속 시간을 올려주는 편집 방법', duration: 15 },
            { id: 'vod_26', title: '편집 시간을 반으로 줄이는 편집 워크플로우', duration: 20 },
            { id: 'vod_27', title: '실전 편집 A to Z : 잡학 지식형 (1)', duration: 18 },
            { id: 'vod_28', title: '실전 편집 A to Z : 잡학 지식형 (2)', duration: 15 },
            { id: 'vod_29', title: '실전 편집 A to Z : 커뮤니티형', duration: 16 },
            { id: 'vod_30', title: '실전 편집 A to Z : 썰형', duration: 25 },
        ],
    },
];
