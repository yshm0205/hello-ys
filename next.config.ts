    ...
    return [
      {
        ...
        headers: [
          ...
          // CSP — XSS 방지
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.tosspayments.com https://cdn.iamport.kr https://cdn.portone.io https://vercel.live https://player.vdocipher.com https://cdn.channel.io",
